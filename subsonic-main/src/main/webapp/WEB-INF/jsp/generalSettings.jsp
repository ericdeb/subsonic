<div id="generalSettingsWrapper" class="mainframe bgcolor1" onload="generalSettingsInit()">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="margin-bottom: 10px">
                                ...
                                <span for="gettingStartedEnabled" style="position: relative; top: 3px;"><fmt:message key="generalsettings.showgettingstarted"/></span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <c:import url="helpToolTip.jsp"><c:param name="topic" value="welcometitle"/></c:import>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <c:import url="helpToolTip.jsp"><c:param name="topic" value="welcomesubtitle"/></c:import>
                        </td>
                    </tr>
                    <tr>
