...
<div class="bgcolor2 topframe" style="margin:0.4em 1em 0.4em 1em; overflow: hidden;">
    ...
    <table style="margin:0"><tr valign="middle">
        ...
        <td style="position: absolute; top: 7px; left: 226px;">
            <table>
                ...
                <td style="min-width:4em;padding-right:1.5em">
                    <a id="topPlaylistLink">
                        <img src="<spring:theme code="genresImage"/>" title="Playlist" alt="Playlist">
                    </a>
                    <br>
                </td>
                <td style="min-width:4em;padding-right:1.5em">
       ...
       <!--              <a href="home.view?" target="main">${home}</a> -->
    	        ...
    	        <td style="min-width:4em;padding-right:1.5em">
                    <a id="genresLink">
                        <img src="<spring:theme code="genresImage"/>" title="Genres" alt="Genres">
                    </a>
                    <br>
    <!-- 	        <a href="genres.view?" target="main">Genres</a> -->
    	        ...
    	        <td style="min-width:4em;padding-right:1.5em">
                    <a id="radioLink">
                        <img src="<spring:theme code="radioImage"/>" title="Radio" alt="Radio">
                    </a>
                    <br>
    ...
    <!--             <td style="min-width:4em;padding-right:1.5em">
                ...
                <c:if test="${model.user.settingsRole}">
                    <td style="min-width:4em;padding-right:1.5em">
                        <a id="settingsLink">
                            <img src="<spring:theme code="settingsImage"/>" title="${settings}" alt="${settings}"></a><br>
    <!--                     <a href="settings.view?" target="main">${settings}</a> -->
                ...
                <c:if test="${model.admin}">
                    <td style="min-width:4em;padding-right:1.5em">
                        <a id="statusLink">
                            <img src="<spring:theme code="statusImage"/>" title="${status}" alt="${status}"></a><br>
    <!--                     <a href="status.view?" target="main">${status}</a> -->
                    </td>
                    <td style="min-width:4em;padding-right:1.5em">
                        <a id="helpLink">
                            <img src="<spring:theme code="helpImage"/>" title="${help}" alt="${help}"></a><br>
