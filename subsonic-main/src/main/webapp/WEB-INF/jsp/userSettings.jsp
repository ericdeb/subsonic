<div id="userSettingsWrapper" class="mainframe bgcolor1" onload="enablePasswordChangeFields();">
    ...
    <div id="scrollWrapper">
        ...
        <div id="scrollContainer">
            ...
            <table class="indent">
                <tr>
                    <td><span style="font-weight: bold; font-size: 22px">Select User</span></td>
                    <td>
                        <select name="username" style="position: relative; left: 7px; top: 4px" onchange="location='userSettings.view?userIndex=' + (selectedIndex - 1);">
            ...
            <form:form method="post" action="userSettings.view" commandName="command">
                <c:if test="${not command.admin}">
                    <table id="userSettings">
                        <tr>
                            ...
                            <td><span for="admin"><fmt:message key="usersettings.admin"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="settingsRole" id="settings" cssClass="checkbox"/></td>
                            <td><span for="settings"><fmt:message key="usersettings.settings"/></span></td>
                        </tr>
                        <tr>
                            <td style="padding-top:1em"><form:checkbox path="streamRole" id="stream" cssClass="checkbox"/></td>
                            <td style="padding-top:1em"><span for="stream"><fmt:message key="usersettings.stream"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="jukeboxRole" id="jukebox" cssClass="checkbox"/></td>
                            <td><span for="jukebox"><fmt:message key="usersettings.jukebox"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="downloadRole" id="download" cssClass="checkbox"/></td>
                            <td><span for="download"><fmt:message key="usersettings.download"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="uploadRole" id="upload" cssClass="checkbox"/></td>
                            <td><span for="upload"><fmt:message key="usersettings.upload"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="shareRole" id="share" cssClass="checkbox"/></td>
                            <td><span for="share"><fmt:message key="usersettings.share"/></span></td>
                        </tr>
                        <tr>
                            <td style="padding-top:1em"><form:checkbox path="playlistRole" id="playlist" cssClass="checkbox"/></td>
                            <td style="padding-top:1em"><span for="playlist"><fmt:message key="usersettings.playlist"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="coverArtRole" id="coverArt" cssClass="checkbox"/></td>
                            <td><span for="coverArt"><fmt:message key="usersettings.coverart"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="commentRole" id="comment" cssClass="checkbox"/></td>
                            <td><span for="comment"><fmt:message key="usersettings.comment"/></span></td>
                        </tr>
                        <tr>
                            <td><form:checkbox path="podcastRole" id="podcast" cssClass="checkbox"/></td>
                            <td><span for="podcast"><fmt:message key="usersettings.podcast"/></span></td>
                        </tr>
                    </table>
                </c:if>
                ...
                <table class="indent">
                    <tr>
                        ...
                        <td>
                            <div style="margin-left: 5px; margin-top: 5px; position: relative; top: 2px; margin-right: 5px">
                ...
                <c:choose>
                    <c:when test="${command.newUser}">
                        ...
                        <table id="userPass" class="indent">
                            <tr>
                ...
                <input type="submit" class="btn" value="<fmt:message key="common.save"/>" style="margin-top:1.5em;margin-right:0.3em">
                <input type="button" class="btn" value="<fmt:message key="common.cancel"/>" onclick="location.href='nowPlaying.view'" style="margin-top:1.5em">
            </form:form>
        </div>
    </div>
</div>
