...
<h2>
<a href="javascript:noop()" onclick="top.playlist.sendPlaylistCommand(P_CMDS.PLAY.TRACKS, ${model.trackIds}, 'P');">Play all</a> |
<a href="javascript:noop()" onclick="top.playlist.sendPlaylistCommand(P_CMDS.PLAY.TRACKS, ${model.trackIds}, 'E');">Enqueue all</a> |
<a href="javascript:noop()" onclick="top.playlist.sendPlaylistCommand(P_CMDS.PLAY.TRACKS, ${model.trackIds}, 'A');">Add all</a>
</h2>
