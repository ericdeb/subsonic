...
<div id="advancedSettingsWrapper" class="mainframe bgcolor1" onload="enableLdapFields()">
        ...
        <div id="scrollContainer">
            ...
            <form:form method="post" action="advancedSettings.view" commandName="command">
                ...
                <table style="white-space:nowrap" class="indent">
                    ...
                    <tr>
                        <td><span style="position: relative; bottom: 2px"><fmt:message key="advancedsettings.downsamplecommand"/></span></td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div id="enableLDAP">
                                ...
                                <span><fmt:message key="advancedsettings.ldapenabled"/></span>
                            </div>
